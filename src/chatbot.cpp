...
{
  std::cout << "COPYING ChatBot of instance " << &source << " to instance "
            << this << std::endl;
...
{
  std::cout << "ASSIGNING ChatBot of instance " << &source << " to instance "
            << this << std::endl;
...
{
  std::cout << "MOVING (c’tor) ChatBot instance " << &source << " to instance "
            << this << std::endl;
